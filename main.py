...
def parse_args() -> Namespace:
    ...
    parser.add_argument('-i', '--in', metavar='PATH', dest='image_path', type=str, required=True)
    parser.add_argument('-s', '--scale', metavar='FLOAT', type=float, default=0.43)
    parser.add_argument('-o', '--out', metavar='PATH', dest='out_txt_path', type=str, default='out.txt')
